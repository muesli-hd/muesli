...
penalty_names = {pref['penalty']: pref['name'] for pref in preferences}
...
# From https://blogs.fluidinfo.com/terry/2012/05/26/autovivification-in-python-nested-defaultdicts-with-a-specific-final-type/
