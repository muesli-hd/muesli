...
from pyparsing import Word, Literal, CaselessLiteral \
    , Combine, Optional, nums, Forward, ZeroOrMore, StringEnd, alphanums, CaselessKeyword
...
class Parser:
    ...
    def cases2(self, parameters):
        p = parameters
        casesParameters = [p[0], dec(5.0), p[1], dec(4.0), p[2], dec(3.5), p[3], dec(3.0), p[4], dec(2.5), p[5],
                           dec(2.0), p[6], dec(1.5), p[7], dec(1.0)]
        return self.cases(casesParameters)

    def cases3(self, parameters):
        p = parameters
        casesParameters = [p[0], dec(5.0), p[1], dec(4.0), p[2], dec(3.7), p[3], dec(3.3), p[4], dec(3.0), p[5],
                           dec(2.7),
    ...
    def cases333(self, parameters):
        p = parameters
        casesParameters = [p[0], dec(5.0), p[1], dec(4.0), p[2], dec(3.0 + 2.0 / 3), p[3], dec(3.0 + 1.0 / 3), p[4],
                           dec(3.0), p[5], dec(2.0 + 2.0 / 3),
                           p[6], dec(2.0 + 1.0 / 3), p[7], dec(2.0), p[8], dec(1.0 + 2.0 / 3), p[9], dec(1.0 + 1.0 / 3),
                           p[10], dec(1.0)]
        return self.cases(casesParameters)
