...
def main(global_config=None, testmode=False, **settings):
    ...
    config.add_route('user_change_email_wait_for_confirmation', '/user/change_email_wait_for_confirmation',
    ...
    config.add_route('user_ajax_complete', '/user/ajax_complete/{lecture_id}/{tutorial_ids:[^/]*}',
                     factory=TutorialContext)
    ...
    config.add_route('lecture_view_removed_students', '/lecture/view_removed_students/{lecture_id}',
                     factory=LectureContext)
    ...
    config.add_route('lecture_export_students_html', '/lecture/export_students_html/{lecture_id}',
                     factory=LectureContext)
    ...
    config.add_route('lecture_export_yaml_details', '/lecture/export_yaml_details',
                     factory=GeneralContext)  # Canh added
    config.add_route('lecture_export_excel', '/lecture/export_excel/downloadDetailTutorials.xlsx',
                     factory=GeneralContext)
    ...
    config.add_route('tutorial_remove_student', '/tutorial/remove_student/{tutorial_ids}/{student_id}',
                     factory=TutorialContext)
    ...
    config.add_route('exam_histogram_for_exercise', '/exam/histogram_for_exercise/{exercise_id}/{tutorial_ids:[^/]*}',
                     factory=ExerciseContext)
    config.add_route('exam_histogram_for_exam', '/exam/histogram_for_exam/{exam_id}/{tutorial_ids:[^/]*}',
                     factory=ExamContext)
    ...
    config.add_route('exam_enter_points_raw', '/exam/enter_points_raw/{exam_id}/{tutorial_ids:[^/]*}',
                     factory=ExamContext)
    config.add_route('exam_enter_points_single', '/exam/enter_points_single/{exam_id}/{tutorial_ids:[^/]*}',
                     factory=ExamContext)
    config.add_route('exam_ajax_get_points', '/exam/ajax_get_points/{exam_id}/{tutorial_ids:[^/]*}',
                     factory=ExamContext)
    config.add_route('exam_ajax_save_points', '/exam/ajax_save_points/{exam_id}/{tutorial_ids:[^/]*}',
                     factory=ExamContext)
    ...
    config.add_route('grading_delete_exam_association', '/grading/delete_exam_association/{grading_id}/{exam_id}',
                     factory=GradingContext)
    config.add_route('grading_enter_grades', '/grading/enter_grades/{grading_id}', factory=GradingContext)
    config.add_route('grading_formula_histogram', '/grading/enter_grades/{grading_id}/formula_histogram',
                     factory=GradingContext)
